...
interface DeliveryPersonSidebarProps {
  links: Array<any>;
...
export default function DeliveryPersonSidebar({
  links,
  isSidebarOpen,
  collapsed,
  emuted = true,
  loading = true,
}: DeliveryPersonSidebarProps) {
