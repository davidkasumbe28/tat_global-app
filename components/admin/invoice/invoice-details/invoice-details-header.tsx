...
interface AdminInvoiceDetailsHeaderProps {
  invoice?: Invoice;
  emuted?: boolean;
  loading: boolean;
}

export default function AdminInvoiceDetailsHeader({
  invoice,
  emuted = true,
  loading,
}: AdminInvoiceDetailsHeaderProps) {

  return (
    <div className="flex justify-between items-center gap-4">
      <div className="flex items-center gap-4">
        <Link href={emuted ? "#" : APP.admin.invoices}>
          <Button
            disabled={emuted}
