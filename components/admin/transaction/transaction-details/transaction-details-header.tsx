...
interface AdminTransactionDetailsHeaderProps {
  transaction?: Transaction;
  emuted?: boolean;
  loading: boolean;
}

export default function AdminTransactionDetailsHeader({
  transaction,
  emuted = true,
  loading,
}: AdminTransactionDetailsHeaderProps) {

  return (
    <div className="flex justify-between items-center gap-4">
      <div className="flex items-center gap-4">
        <Link href={emuted ? "#" : APP.admin.transactions}>
          <Button
            disabled={emuted}
