...
interface AccountTransactionDetailsSheetProps {
  transaction?: Transaction;
  emuted?: boolean;
  loading: boolean;
}

export default function AccountTransactionDetailsSheet({
  transaction,
  emuted = true,
  loading,
}: AccountTransactionDetailsSheetProps) {
    ...
    <div className="border border-border rounded-lg p-6 space-y-6">
      ...
      <div className="flex max-md:flex-col-reverse justify-between">
        <div className="flex justify-end items-end gap-3">
          ...
          <Link className="hover:text-primary-dark" href={emuted && loading ? "#" : APP.private.invoices + "/" + transaction?.invoiceId} >
