...
export default function PrivateNavigation() {
  ...
  const { logout, isLoggedIn, user, isloadingAuth } = useAuth();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-4  ">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center gap-2 md:gap-1 lg:gap-2 ">
              ...
              {/* Admin Button, Account Button , In progress Button and Logout Button  */}
              <div className="flex items-center gap-2 md:gap-1 lg:gap-2">
                {isLoggedIn && user?.status === STATUS_USER.online ? (
                  <>
                    {/* Admin Button */}
                    {user?.role !== RoleUser.USER && (
                      ...
                      >
                        <Button
                          size="sm"
                          variant={
                            isloadingAuth || isloading ? "emuted" : "default"
                          }
                          disabled={isloadingAuth || isloading}
                          className={cn(
                            isloadingAuth || isloading
                    ...
                    <Link
                      href={
                        isloadingAuth || isloading ? "#" : APP.private.account
                      }
                  ...
                  <>
                    {/* In progress Button */}
                    {isLoggedIn && user?.status === STATUS_USER.in_progress && (
                      <Link
                        href={
                          isloadingAuth || isloading
                            ? "#"
                ...
                <Button
                  size="sm"
                  variant={isloadingAuth || isloading ? "emuted" : "ghost"}
                  disabled={isloadingAuth || isloading}
